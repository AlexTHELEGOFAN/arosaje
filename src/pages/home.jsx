...
const fakeAds = [
  ...
  },
  {
    // I only need the id
    id_annonce: 2,
    titre_annonce: "Annonce 2",
    description_annonce: "Description 2",
    image_annonce: "https://picsum.photos/800/600?random=2",
    prix_annonce: 20,

    // I only need the id
    id_plante: 2,
    nom_plante: "nom plante 2",
    espece_plante: "espece plante 2",
    adresse_plante: "location plante 2",

    // I only need the id
    id_proprio: 2,
    nom_proprio: "nom proprio 2",
    prenom_proprio: "prenom proprio 2",
    absent: false,
  },
  {
    // I only need the id
